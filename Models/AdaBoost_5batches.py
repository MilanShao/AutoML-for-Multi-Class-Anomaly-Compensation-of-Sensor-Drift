...
# Use AdaBoost for classification with Decision Tree as the base estimator
base_estimator = DecisionTreeClassifier(max_depth=10)
adaboost_classifier = AdaBoostClassifier(base_estimator=base_estimator, n_estimators=100, learning_rate=1.0)
