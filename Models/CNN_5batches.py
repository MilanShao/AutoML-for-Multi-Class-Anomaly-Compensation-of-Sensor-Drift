...
model.add(Dense(units=y_train_one_hot.shape[1], activation='softmax'))  # Use softmax for multi-class
...
# Map test labels to integers and convert to one-hot encoding
